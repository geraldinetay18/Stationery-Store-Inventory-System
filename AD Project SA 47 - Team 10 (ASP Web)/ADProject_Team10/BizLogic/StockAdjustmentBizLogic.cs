...
namespace ADProject_Team10.BizLogic
{
    ...
    public class StockAdjustmentBizLogic
    {
        ...
        IStockManagementService smService = new StockManagementService();
        ...
        public void ReportAdjustmentList(List<int> listAdjustmentId, string message)
        {
            foreach (int id in listAdjustmentId)
                saService.ReportAdjustment(id, message);
        }
